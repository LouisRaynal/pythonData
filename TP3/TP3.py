...
#os.chdir('E:/2023_2024_S2_Analyse de données avec Python/TP3')
#os.chdir('D:/Louis/Documents/Cours_AnlayseDeDonneesPython/TP3')
...
df.head(10)
# Le dixième passager est de deuxième classe
...
# Alternative : spécifier le nom de la colonne où se trouve les NaN
...
# Les hommes de troisième classe ont un taux de survie de 15%
...
groupAges = pd.cut(df.age, bins=[0,20,40,60,80], include_lowest=True)
