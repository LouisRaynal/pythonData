...
# Variables quantitatives discrètes : vitamines (car uniquement trois modalités possibles), étagère
...
#os.chdir('D:/Louis/Documents/Cours ICES/Cours_AnalyseDeDonneesPython/TP2')
