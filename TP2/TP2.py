...
#os.chdir('E:/2023_2024_S2_Analyse de données avec Python/TP2')
...
# 3. Visualisons des lignes et colonnes avec au moins un NaN ou None
...
## à la méthode agg
df.groupby('fabricant').agg(func=[np.mean,np.median])

# et en vous limitant à certaines colonnes
...
RsquareVerif = varianceInter / varNotes
RsquareVerif
