...
array1D[:]      # tous les indices
array1D[1]      # indice 1
array1D[1:3]    # indices 1 à 3 exclu
array1D[1:]     # tout à partir de l'indice 1
array1D[:4]     # tout avant l'indice 4 exclu
array1D[-1]     # dernier indice
array1D[-3:]    # tout à partir de l'avant avant dernier indice
array1D[[0,4,2]]  # via une liste d'indice
